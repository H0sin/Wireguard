            ...
            string updateQuery = """
                                 ...
                                 SET
                                     ...
                                     TotalReceivedVolume = CASE
                                         ...
                                         THEN ROUND(((peer_data.ReceivedBytes * peer_data.DownloadPercent) - peer_data.DownloadVolume) + ((peer_data.SentBytes * peer_data.UploadPercent) - peer_data.UploadVolume))
